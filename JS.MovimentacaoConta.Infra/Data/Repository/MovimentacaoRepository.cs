...
namespace JS.MovimentacaoConta.Infra.Data.Repository
{
    public class MovimentacaoRepository : IMovimentacaoRepository
    {
        ...
        public async Task<IEnumerable<MovimentacaoFinanceira>> ObterTodos()
        {
            return await _context.MovimentacaoFinanceira.AsNoTracking().OrderBy(c => c.DataPagamento).ToListAsync();
        }
