...
namespace JS.MovimentacaoConta.Infra.Data
{
    public sealed class MovimentacaoContext : DbContext, IUnitOfWork
    {
        private readonly IMediatorHandler _mediatorHandler;
        public MovimentacaoContext(DbContextOptions<MovimentacaoContext> options, IMediatorHandler mediatorHandler)
            : base(options)
        {
